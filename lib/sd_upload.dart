...
class SDUploadPage extends StatefulWidget {
  final String name = 'Secondary Document';
  final Color color = mainColor;

  @override
  _SDUploadPageState createState() => _SDUploadPageState();
}

class _SDUploadPageState extends State<SDUploadPage> {
  int nop = 1;
